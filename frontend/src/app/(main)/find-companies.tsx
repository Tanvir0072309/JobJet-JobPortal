    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {companies.length === 0 ? (
        <EmptyState
          ...
          description="Search a location above to discover companies. Results come from real map data (OpenStreetMap) — nothing here is fabricated."
        />
      ) : (
...
const styles = StyleSheet.create({
  ...
  companyCardSelected: { borderColor: colors.primary, backgroundColor: colors.surfaceMuted },
